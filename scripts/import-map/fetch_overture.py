...
box = (pc.field('bbox', 'xmin') > -1.466) & (pc.field('bbox', 'xmax') < -1.426) & (pc.field('bbox', 'ymin') > 53.399) & (pc.field('bbox', 'ymax') < 53.419)
...
for z, (n_, s_, w_, e_) in [(15, (53.4185, 53.399, -1.466, -1.426)), (12, (LAT0 + 8000 / KZ, LAT0 - 8000 / KZ, LON0 - 8000 / KX, LON0 + 8000 / KX))]:
